<script>
	...
	const updateHeaderStatus = (event) => active = event.detail.status;
</script>

<header class="header{active?' active' : ''}">
	<nav class="container{active?' active' : ''}">
		<a class="brand" href="/">
		...
		<MobileMenu on:headerStatus={updateHeaderStatus} />
		...
		<a class="button button--cta-top" href="/">Get an invite</a>
	</nav>
